...
import com.kiktor.v2whitelist.AppConfig.GEOIP_PRIVATE
import com.kiktor.v2whitelist.AppConfig.GEOSITE_PRIVATE
import com.kiktor.v2whitelist.AppConfig.TAG_DIRECT
import com.kiktor.v2whitelist.AppConfig.VPN
import com.kiktor.v2whitelist.enums.EConfigType
import com.kiktor.v2whitelist.enums.Language
import com.kiktor.v2whitelist.dto.ProfileItem
import com.kiktor.v2whitelist.enums.RoutingType
import com.kiktor.v2whitelist.dto.RulesetItem
import com.kiktor.v2whitelist.dto.ServersCache
import com.kiktor.v2whitelist.dto.V2rayConfig
import com.kiktor.v2whitelist.enums.VpnInterfaceAddressConfig
import com.kiktor.v2whitelist.handler.MmkvManager.decodeServerConfig
import com.kiktor.v2whitelist.handler.MmkvManager.decodeServerList
        ...
        try {
            ...
            assets.list("")
                ...
                ?.forEach {
                    ...
                    Log.v(AppConfig.TAG, "Copied from apk assets folder to ${target.absolutePath}")
                }
        } catch (e: Exception) {
