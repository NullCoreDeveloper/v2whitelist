...
const file_transport_internet_splithttp_config_proto_rawDesc = "" +
	...
	"%com.xray.transport.internet.splithttpP\x01Z6github.com/kiktor/v2w-core/transport/internet/splithttp\xaa\x02!Xray.Transport.Internet.SplitHttpb\x06proto3"
